...
const Channel = require('../mockup-models/channelModel');
const User = require('../mockup-models/userModel');
const Video = require('../mockup-models/videoModel');
...
exports.createChannel = catchAsync(async (req, res, next) => {
  try {
    // THIS CODE IS ONLY FOR USE CASES WHERE WE HAVE AUTHENTICATION ENABLED.
    ...
    */
    ...
    // IMPORTANT:Find Users By Manually Checking The Id of the user.
