/* eslint-disable */ const homeSectionBtn = document.querySelector('.ctnt-nav-item-1');
...
const wiresSection = document.querySelector('.sect-mid-ch-wire'); // window.addEventListener('click', (event) => {
...
//# sourceMappingURL=base.81cf15bf.js.map
