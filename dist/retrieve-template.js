...
})(
  {
    pbaJN: [
      function (require, module, exports, __globalThis) {
        ...
        module.bundle.HMR_BUNDLE_ID = '42bdd630cf4f4f39';
        ('use strict');
...
${frame.code}`;
    ...
    f9Dze: [
      function (require, module, exports, __globalThis) {
        const axios = require('2d526b81096ae3b7');
        console.log('HI FROM FRONTEND');
        axios
          .get('http://127.0.0.1:80/') // Use the actual backend URL
          .then((res) => {
...
//# sourceMappingURL=retrieve-template.js.map
